...
//                     </span>
//                 </p>
//                 <p className="text-sm md:text-lg px-8 text-neutral-500 max-w-2xl mx-auto py-4">
//                     Break free from traditional boundaries. Work from anywhere, at the
//                     comfort of your own studio apartment. Perfect for Nomads and
//                     Travellers.
//                 </p>
...
export function WorldMapDemo() {
    return (
        <div className=" dark:bg-[#ececec] bg-white w-[100%]  h-[100%]">
            <div className=" mx-auto text-center ">
                ...
                {/* Map Container */}
                <div className="relative w-full  aspect-video overflow-hidden md:overflow-visible">
                    <div className="md:transform-none transform lg:scale-100 scale-120 origin-center mt-[10px] lg:mt-[0px] lg:pt-0 pt:5 lg:pb-0 pb-45">
                        <WorldMap 
                            dots={[
                                {
                                    start: { lat: 80.2008, lng: -149.4937, name: "Alaska" },
                                    end: { lat: 34.0522, lng: -118.2437, name: "Los Angeles" },
                                },
                                {
                                    start: { lat: 80.2008, lng: -149.4937, name: "Alaska" },
                                    end: { lat: -15.7975, lng: -47.8919, name: "Brasília" },
                                },
                                {
                                    start: { lat: -15.7975, lng: -47.8919, name: "Brasília" },
